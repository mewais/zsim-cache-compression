...
//     {
//         minValue->HOOKS_DOUBLE = -380703.052254;
//         maxValue->HOOKS_DOUBLE = 353640.241113;
//     }
//     else
//     {
//         minValue->HOOKS_FLOAT = -0.0000001;
// 	    maxValue->HOOKS_FLOAT = 16384.000001;
//     }
...
static void zsim_mallocs_init(/*DataType Type, DataValue* Min, DataValue* Max*/)
{
    ...
    GlobalMin->HOOKS_DOUBLE = 0;
    GlobalMax->HOOKS_DOUBLE = 11;
